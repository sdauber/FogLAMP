...
UPDATE foglamp.configuration SET value = jsonb_set(value, '{source}', '{"source": {"description": "Source of data to be sent on the stream. May be either readings, statistics or audit.", "type": "string", "default": "audit", "value": "readings"}}')
        WHERE key = 'North Readings to PI';
...
UPDATE foglamp.configuration SET value = jsonb_set(value, '{source}', '{"source": {"description": "Source of data to be sent on the stream. May be either readings, statistics or audit.", "type": "string", "default": "audit", "value": "statistics"}}')
        WHERE key = 'North Statistics to PI';
